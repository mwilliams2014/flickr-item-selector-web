AUI.add(
	...
	function(A) {
		...
		var FlickrItemSelector = A.Component.create(
			{
				ATTRS: {
					closeCaption: {
				...
				prototype: {
					initializer: function() {
						...
						instance._flickerImageSelectorWrapper = instance.one('#flickerImageSelectorWrapper');
					...
					_bindUI: function() {
						...
						instance._eventHandles = [
							...
							instance._flickerImageSelectorWrapper.delegate('click', instance._previewItem, '.flickr-image', instance)
						];
					},
		...
		Liferay.FlickrItemSelector = FlickrItemSelector;
	},
	'',
	{
